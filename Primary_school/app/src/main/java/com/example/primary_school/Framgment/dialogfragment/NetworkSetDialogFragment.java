...
public class NetworkSetDialogFragment extends DialogFragment{
    private Button btn_net1,btn_net2;
    public String grade;
    public OnDialogListener mlistener;
    public NetworkSetDialogFragment() {
        super();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialogfragment_netset,container,false);
        //设置背景为透明
