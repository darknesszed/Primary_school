...
public class Fragment_mzbk extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.tab_2_fragment,container,false);
        init_tabrecyclerview_mzbk();
        SmartRefreshLayout smartRefreshLayout = view.findViewById(R.id.smartrefresh_mzbk);
